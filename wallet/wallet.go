...
func NewTransaction(privateKey *ecdsa.PrivateKey, publicKey *ecdsa.PublicKey, sender string, recipient string, value float32) *Transactions {
	return &Transactions{privateKey, publicKey, sender, recipient, value}
}

func (t *Transactions) GenerateSignature() *utils.Signature {
	m, _ := json.Marshal(t)
